...
def detect():
    ...
    subprocess.run(['python', 'detect.py', '--weights', 'best.pt', '--source', os.path.join(uploads_dir, secure_filename(video.filename))], shell=True)
...
def return_file():
    ...
    sample=24314
    print(loc)
    #return render_template("index.html", user_image = sample)
    try:
